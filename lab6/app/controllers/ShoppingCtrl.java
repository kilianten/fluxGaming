...
public class ShoppingCtrl extends Controller {
    ...
    public Result viewOrders(){
        return ok(viewOrders.render(getCurrentUser(), getCurrentUser().getOrders()));
    }

    @Transactional
    public Result cancelOrder(long id){
        ShopOrder order = ShopOrder.find.ref(id);

        if(order.isWithinTime()){
            ...
            flash("success", "Sorry, orders can only be cancelled within an hour of ordering");
