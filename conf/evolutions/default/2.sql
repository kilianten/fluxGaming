...
INSERT INTO Review VALUES(1,'Max Payne', 'A classic thats worth revisiting.', 'kilian', 'review', 7,2001, '2018-03-12');
...
INSERT INTO Review VALUES(3,'Orwell', 'A very interesting concept with some surreal gameplay', 'kilian', 'review', 7,2016, '2018-03-12');

INSERT INTO Review VALUES(4,'Mafia III', 'After a bad launch and now revisiting, was this game worth all the hate?', 'kilian', 'review', 4, 2016, '2018-03-12');

INSERT INTO Review VALUES(5,'Maize', 'Some impressive art held back by cringey humour and banal gamepplay', 'kilian', 'review', 3,2016,'2018-03-12');

INSERT INTO Review VALUES(6,'Prey', 'Great story with some incredible mechanics', 'kilian', 'review', 8,2006,'2018-03-12');

INSERT INTO Review VALUES(7,'Killing Floor 2', 'While it is quite fun, it lacks the long term engagement that other shooters benifit from.', 'kilian', 'review', 6,2006,'2018-03-12');
