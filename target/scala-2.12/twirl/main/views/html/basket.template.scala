...
"""),_display_(/*3.2*/main("Cart", loginForm, user)/*3.31*/{_display_(Seq[Any](format.raw/*3.32*/("""
    ...
    <div class="row">
        <div class="col-md-3">
            <p class="text-left">
                <a href=""""),_display_(/*65.27*/routes/*65.33*/.ShoppingController.emptyBasket()),format.raw/*65.66*/("""" class="btn btn-danger btn-sm" onclick="return confirmDel();">
                <span class="glyphicon glyphicon-trash"></span> Empty Basket</a>
            </p>
        </div>  
        <div class="col-md-3">
            <p class="text-left">
                <a href=""""),_display_(/*71.27*/routes/*71.33*/.ShoppingController.placeOrder()),format.raw/*71.65*/("""" class="btn btn-success btn-sm">
