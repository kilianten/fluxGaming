    ...
    <div class="row">
        ...
        """),_display_(/*18.10*/for(i <- orders.indices) yield /*18.34*/ {_display_(Seq[Any](format.raw/*18.36*/("""
            ...
            <div class="row">
                    ...
                    <div class="col-md-9">
                        <p class="text-right"><strong>Order Total: &euro; """),_display_(/*55.76*/("%.2f".format(orders.get(i).getOrderTotal))),format.raw/*55.120*/("""</strong></p>
                    </div>  
                </div>
            </div>
        </div>
